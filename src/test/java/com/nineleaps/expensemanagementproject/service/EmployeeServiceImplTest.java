...
class EmployeeServiceImplTest {
    ...
    void testInsertUser() {
        ...
        newUser.setEmployeeEmail("user@example.com");
        newUser.setFirstName("John");
        newUser.setLastName("Doe");

        // Mock employee returned by the repository
        Employee savedEmployee = new Employee();
        savedEmployee.setEmployeeId(1L);
        savedEmployee.setEmployeeEmail(newUser.getEmployeeEmail());
        savedEmployee.setFirstName(newUser.getFirstName());
        savedEmployee.setLastName(newUser.getLastName());

        // Mock employeeRepository.save method
        when(employeeRepository.save(newUser)).thenReturn(savedEmployee);

        // Call the method
        Employee result = employeeService.insertuser(newUser);

        // Verify the result
        assertEquals(savedEmployee, result);

        // Verify the method invocation
        verify(employeeRepository, times(1)).save(newUser);
    }
    ...
    void testFindByEmailId() {
        ...
        // Mock employeeRepository.findByEmployeeEmail method
        ...
        // Verify the method invocation
        verify(employeeRepository, times(1)).findByEmployeeEmail(emailId);
    }
