	...
	@Autowired
	 private JwtUtil jwtUtil;
		public static String getEmailFromJwt(String jwt) {
		    ...
		    //fetch the email from the token given to verify the user -whether present in db or not
//		    @PostMapping("/login")
...
//		  
//		   
//			String token = jwtUtil.generateToken(user.getEmployeeEmail(), user.getFirstName(),user.getImageUrl());
